...
tar --exclude='$_directory/..' --exclude='/ram' --exclude='/tmp' --exclude='/proc' --exclude='/sys' --exclude='/mnt' --exclude='/media' --exclude='/run' --exclude='/dev' --exclude='/proc' --exclude='/sys' -cvzf - / | gpg --encrypt --quiet --recipient $_user > $_directory/"$_mark".tar.gz.gpg
